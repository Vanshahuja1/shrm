    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6">
        {tasks
          ...
          .map((task) => (
            <div key={task.id} className="bg-white rounded-lg shadow-sm border border-blue-200 p-6">
              ...
              {task.response && (
                <div className="bg-blue-50 rounded-lg p-4 mb-4">
                  ...
                  {task.response.documents && task.response.documents.length > 0 && (
                    <div className="mb-2">
                      <span className="text-sm text-blue-700">Attachments:</span>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-blue-600">Submitted: {task.response.submittedAt}</span>
                    <span
                ...
                <div className="border-t border-blue-100 pt-4">
                  {selectedTask === task.id ? (
                    <div className="space-y-4">
                      ...
                      {responseFormat === "document" && (
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                          ...
                          <p className="text-gray-600 text-sm">Click to upload documents or drag and drop</p>
                    ...
                    >
                      ...
                      <span>{task.response ? "Update Response" : "Add Response"}</span>
                    </button>
                  )}
                </div>
              )}
