...
interface EmployeeResponsePageProps {
  managerInfo: ManagerInfo;
  tasks : Task[];
}

const EmployeeResponsePage: React.FC<EmployeeResponsePageProps> = ({ managerInfo , tasks }) => {
    ...
    const combinedPercentage =
      (tasksScore + attendanceScore + managerReviewScore) / 3;
  ...
  return (
     <div className="space-y-6">
      <h2 className="text-2xl font-bold text-gray-900">
        Employee Response & Performance Tracking
      </h2>
