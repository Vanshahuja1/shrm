...
import { Clock, LogIn, LogOut, Edit, CheckCircle } from "lucide-react";
...
type AttendancePageProps = {
  handleRegularization: (record: AttendanceRecord, reason: string) => void;
};
const AttendanceManagementPage: React.FC<AttendancePageProps> = ({handleRegularization}) => {
                  ...
                  <td className="py-3 px-4">
                    <div className="flex space-x-2">
                      ...
                      {!record.regularized && record.status !== "present" && (
                        <button
                          onClick={() =>
                            handleRegularization(record, "Approved by manager")
                          }
          ...
          {punchTime && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <p className="text-red-700 font-medium">
                {isPunchedIn ? "Punched In" : "Punched Out"} at:{" "}
